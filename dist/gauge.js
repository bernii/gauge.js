...
(function() {
  var AnimatedText, AnimatedTextFactory, Bar, BaseDonut, BaseGauge, Donut, Gauge, GaugePointer, TextRenderer, ValueUpdater, addCommas, cutHex, formatNumber, mergeObjects, secondsToString, _ref, _ref1,
  ...
  GaugePointer = (function(_super) {
    ...
    function GaugePointer(gauge) {
      ...
      this.setOptions(this.gauge.options.pointer);
    }
  ...
  Gauge = (function(_super) {
    ...
    Gauge.prototype.set = function(value) {
      ...
      i = 0;
      max_hit = false;
      var options = {maxValue: this.maxValue,angle: this.options.angle};
    ...
    Gauge.prototype.render = function() {
      ...
      if (this.options.customFillStyle !== void 0) {
        ...
        if (this.options.gradientType === 0) {
          ...
          fillStyle = this.ctx.createLinearGradient(0, 0, this.canvas.width, 0);
        }
        if(this.options.gradientColors){
	        var colores = this.options.gradientColors;
	        for(var gc=0; gc < colores.length; gc++)
	        	fillStyle.addColorStop(colores[gc][0],colores[gc][1]);
        }else{
