(function() {
  ...
  Gauge = (function(_super) {
    ...
    Gauge.prototype.renderStaticLabels = function(staticLabels, w, h, radius) {
      var FIRST_INDEX, LAST_INDEX, firstLastHorizontal, font, fontsize, j, match, re, rest, rotationAngle, value, _i, _len, _ref;
      this.ctx.save();
      ...
      if (this.options.angle === 0 && staticLabels.firstLastHorizontal) {
        ...
        if (value.label !== void 0) {
          if ((!this.options.limitMin || value >= this.minValue) && (!this.options.limitMax || value <= this.maxValue)) {
            ...
            if (firstLastHorizontal && j === FIRST_INDEX) {
              ...
              this.ctx.fillText(formatNumber(value, staticLabels.fractionDigits), -radius - this.lineWidth / 2, fontsize + 5);
